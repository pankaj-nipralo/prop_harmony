import PaymentsMaster from "@/components/landlord/Payments/PaymentsMaster";
...
const Payemnt = () => {
  return (
    ...
    //           <div className="mt-4">
    //             <div className="w-8 h-8 mx-auto border-4 border-blue-500 rounded-full border-t-transparent animate-spin"></div>
    //           </div>
    //         </div>
    //       </div>
    //     </div>
