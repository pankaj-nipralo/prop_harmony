                  ...
                  hover:bg-[#3b83f7] hover:text-white font-medium"
					...
					>
						...
						<div className="flex justify-end mb-4 ">
							<Dialog open={showDocDialog} onOpenChange={setShowDocDialog} className="w-full bg-amber-50">
					...
					>
						<h3 className="mb-2 text-lg font-semibold">Tenant Information</h3>
						{tenants.length === 0 ? (
									...
									<tbody>
										{tenants.map((tenant, idx) => (
											<tr key={idx} className="border-b border-gray-100">
												...
												<td className="px-2 py-2">{tenant.email}</td>
												<td className="px-2 py-2">{tenant.phone}</td>
												<td className="px-2 py-2">{tenant.moveIn}</td>
												<td className="px-2 py-2">{tenant.leaseEnd}</td>
												<td className="px-2 py-2">{tenant.status}</td>
											</tr>
										))}
									</tbody>
								</table>
					...
					>
						<div className="grid grid-cols-1 gap-4 p-6 bg-transparent md:grid-cols-2 lg:grid-cols-4">
							...
							<div className="p-6 bg-white border border-gray-200 rounded-xl">
								<div className="mb-1 text-sm text-gray-500">Security Deposit</div>
								<div className="text-2xl font-bold text-[#223a5f]">
									AED 0
								</div>
							</div>
							...
							<div className="p-6 bg-white border border-gray-200 rounded-xl">
								<div className="mb-1 text-sm text-gray-500">Current Balance</div>
								<div className="text-2xl font-bold text-green-600">
									AED 0 credit
								</div>
							</div>
